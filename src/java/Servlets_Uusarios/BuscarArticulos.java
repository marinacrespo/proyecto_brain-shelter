 ...
 * @author Alumno
 */
@WebServlet(name = "BuscarArticulos", urlPatterns = {"/BuscarArticulos"})
public class BuscarArticulos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String Btitulo = request.getParameter("tituloART");
            out.println(Btitulo);

            String sql1 = "select titulo, desc_art, precio, unidades, foto from articulos where UPPER(titulo) LIKE '%"+Btitulo+"%'";
            ...
            response.sendRedirect("mostrarstock.jsp"); //AUN NO CREADA
        } catch (Exception e) {
            e.printStackTrace();
        }
