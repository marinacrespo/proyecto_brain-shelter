 ...
 * @author Alumno
 */
@WebServlet(name = "ListarStock", urlPatterns = {"/ListarStock"})
public class ListarStock extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql1 = "select titulo, desc_art, precio, unidades, foto from articulos where cod_art IS NOT NULL ";
