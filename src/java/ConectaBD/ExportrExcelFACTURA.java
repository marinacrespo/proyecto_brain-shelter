 ...
 * @author Alumno
 */
public class ExportrExcelFACTURA {
    
    ConectaBD bd;

    public void export(String nombreusuario) {

        String excelFilePath = "C:\\xampp\\tomcat\\webapps\\excel\\tufactura.xlsx";
        ...
        try {
            ...
            XSSFSheet sheet = workbook.createSheet("tufactura");
